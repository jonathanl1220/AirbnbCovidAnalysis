...
After making my previous observation I decided to run an OLS regression on the **Price** for the two periods. I used **Accommadates** as X value because it was the most statistically significant.
